...
<div class="row">
    <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 1, 'status' => 'Finished','category'
        ...
        741,'progress' => 100]); ?><?php echo $__env->renderComponent(); ?></div>
    ...
    <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 2, 'status' =>
        ...
        'noTasks' => 81, 'noComments' => 103,'progress' => 21]); ?><?php echo $__env->renderComponent(); ?></div>
    ...
    <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 3, 'status' =>
        ...
        'noTasks' => 12, 'noComments' => 48,'progress' => 66]); ?><?php echo $__env->renderComponent(); ?></div>
    ...
    <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 4, 'status' =>
        ...
        'noTasks' => 50, 'noComments' => 1024,'progress' => 100]); ?><?php echo $__env->renderComponent(); ?></div>
    ...
    <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 5, 'status' =>
        ...
        'noTasks' => 3, 'noComments' => 104,'progress' => 45]); ?><?php echo $__env->renderComponent(); ?></div>
    ...
    <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 6, 'status' =>
        ...
        cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad squid.','dueDate' => '20 Dec',
        'noTasks' => 11, 'noComments' => 201,'progress' => 55]); ?><?php echo $__env->renderComponent(); ?></div>
    ...
    <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 8, 'status' =>
        ...
        3, 'noComments' => 104,'progress' => 100]); ?><?php echo $__env->renderComponent(); ?></div>
</div>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.vertical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Laravel\laravel\resources\views/apps/project/list.blade.php ENDPATH**/ ?>