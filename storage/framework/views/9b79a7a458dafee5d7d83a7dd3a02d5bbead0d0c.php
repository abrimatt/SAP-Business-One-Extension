            ...
            <div class="card-body">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="pills-projects" role="tabpanel" aria-labelledby="pills-projects-tab">
                        ...
                        <div class="row mt-3">
                            <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 1, 'status'
                                => 'Finished','category'
                                ...
                                'noComments' =>
                                741,'progress' => 100, 'bodyClass' => 'border']); ?><?php echo $__env->renderComponent(); ?></div>

                            <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 2, 'status'
                                =>
                                ...
                                'noTasks' => 81, 'noComments' => 103,'progress' => 21, 'bodyClass' => 'border']); ?><?php echo $__env->renderComponent(); ?></div>

                            <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 3, 'status'
                                =>
                                ...
                                'noTasks' => 12, 'noComments' => 48,'progress' => 66, 'bodyClass' => 'border']); ?><?php echo $__env->renderComponent(); ?></div>

                            <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 4, 'status'
                                =>
                                ...
                                'noTasks' => 50, 'noComments' => 1024,'progress' => 100, 'bodyClass' => 'border']); ?><?php echo $__env->renderComponent(); ?></div>

                            <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 5, 'status'
                                =>
                                'Ongoing','category' => 'Android','name' => 'Hyper 2.2 - Vue.Js and Laravel',
                                'description' => 'Anim pariatur
                                cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad
                                squid.','dueDate' => '17 Dec',
                                'noTasks' => 3, 'noComments' => 104,'progress' => 45, 'bodyClass' => 'border']); ?><?php echo $__env->renderComponent(); ?></div>

                            <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 6, 'status'
                                =>
                                'Planned','category' => 'Web Design','name' => 'Hyper 2.3 - Rails, NodeJs, Mean',
                                'description' => 'Anim pariatur
                                cliche reprehenderit, enim eiusmod high life accusamus terry richardson ad
                                squid.','dueDate' => '20 Dec',
                                'noTasks' => 11, 'noComments' => 201,'progress' => 55, 'bodyClass' => 'border']); ?><?php echo $__env->renderComponent(); ?></div>

                            <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 7, 'status'
                                =>
                            ...
                            <div class='col-xl-4 col-lg-6'><?php $__env->startComponent('apps.project.project-item', ['id' => 8, 'status'
                                =>
                                ...
                                '30 Dec', 'noTasks' =>
                                3, 'noComments' => 104,'progress' => 100, 'bodyClass' => 'border']); ?><?php echo $__env->renderComponent(); ?></div>
                        </div>
                        <!-- end row -->
                    </div>
                    ...
                    <div class="tab-pane fade" id="pills-tasks" role="tabpanel" aria-labelledby="pills-tasks-tab">
                        ...
                        <div class="card mb-0 shadow-none">
                            <div class="card-body">
                                <?php $__env->startComponent('apps.task.task-item', ['id' => 1, 'title' => 'Draft the new
                                contract document for sales team', 'assignedTo' => 'Arya Stark','dueDate' =>
                                'Today 10am', 'noChecklists' => 3, 'noComments' => 2,'priority' =>
                                'High', 'assigneeAvatar' =>
                                '/assets/images/users/avatar-9.jpg']); ?><?php echo $__env->renderComponent(); ?>

                                <?php $__env->startComponent('apps.task.task-item', ['id' => 2, 'title' => 'iOS App home
                                page', 'assignedTo' => 'James B','dueDate' => 'Today 4pm', 'noChecklists' =>
                                3, 'noComments' => 2,'priority' => 'High', 'assigneeAvatar' =>
                                '/assets/images/users/avatar-3.jpg']); ?><?php echo $__env->renderComponent(); ?>

                                <?php $__env->startComponent('apps.task.task-item', ['id' => 3, 'title' => 'Write a release
                                note', 'assignedTo' => 'Kevin C','dueDate' => 'Today 4pm', 'noChecklists' =>
                                3, 'noComments' => 3,'priority' => 'Medium', 'assigneeAvatar' =>
                                '/assets/images/users/avatar-4.jpg']); ?><?php echo $__env->renderComponent(); ?>

                                <?php $__env->startComponent('apps.task.task-item', ['id' => 4, 'title' => 'Invite user to
                                a project', 'assignedTo' => 'Arya Stark','dueDate' => 'Tomorrow 10am',
                                'noChecklists' => 3, 'noComments' => 2,'priority' => 'Low',
                                'assigneeAvatar' => '/assets/images/users/avatar-9.jpg']); ?><?php echo $__env->renderComponent(); ?>

                                <?php $__env->startComponent('apps.task.task-item', ['id' => 5, 'title' => 'Enable
                                analytics tracking', 'assignedTo' => 'James B','dueDate' => '27 Aug
                                10am', 'noChecklists' => 3, 'noComments' => 2,'priority' => 'Low',
                                'assigneeAvatar' => '/assets/images/users/avatar-5.jpg']); ?><?php echo $__env->renderComponent(); ?>

                                <?php $__env->startComponent('apps.task.task-item', ['id' => 6, 'title' => 'Code HTML
                                email template', 'assignedTo' => 'Kevin C','dueDate' => 'No Due Date',
                                'noChecklists' => 3, 'noComments' => 2,'priority' => 'Medium',
                                'assigneeAvatar' => '/assets/images/users/avatar-6.jpg']); ?><?php echo $__env->renderComponent(); ?>

                                <?php $__env->startComponent('apps.task.task-item', ['id' => 7, 'title' => 'Coordinate
                                with business development', 'assignedTo' => 'Arya Stark','dueDate' =>
                                'No Due Date', 'noChecklists' => 3, 'noComments' => 2,'priority' =>
                                'High', 'assigneeAvatar' =>
                                '/assets/images/users/avatar-9.jpg']); ?><?php echo $__env->renderComponent(); ?>

                                <?php $__env->startComponent('apps.task.task-item', ['id' => 8, 'title' => 'Kanban board
                                design', 'assignedTo' => 'James B','dueDate' => '30 Aug 10am',
                                'noChecklists' => 3, 'noComments' => 2,'priority' => 'Low',
                                'assigneeAvatar' => '/assets/images/users/avatar-5.jpg']); ?><?php echo $__env->renderComponent(); ?>

                                <?php $__env->startComponent('apps.task.task-item', ['id' => 9, 'title' => 'Draft the new
                                contract document for sales team', 'assignedTo' => 'Kevin C','dueDate'
                                => 'No Due Date', 'noChecklists' => 3, 'noComments' => 2,'priority' =>
                                'Medium', 'assigneeAvatar' =>
                                '/assets/images/users/avatar-6.jpg']); ?><?php echo $__env->renderComponent(); ?>

                                <?php $__env->startComponent('apps.task.task-item', ['id' => 10, 'title' => 'Draft the new
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.vertical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Laravel\laravel\resources\views/pages/profile.blade.php ENDPATH**/ ?>