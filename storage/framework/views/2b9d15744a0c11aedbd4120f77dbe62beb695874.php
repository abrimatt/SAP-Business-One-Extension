                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-6 p-5">
                                ...
                                <form action="<?php echo e(route('password.email')); ?>" method="post" class="authentication-form">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.non-auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Laravel\laravel\resources\views/auth/passwords/email.blade.php ENDPATH**/ ?>