        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-xl-2 col-sm-4">
                            <div class="form-group mt-3 mt-sm-0">
                                ...
                                <input class="form-control" value="<?php echo e($stockIssue->DocDate); ?>" placeholder="Posting Date" readonly />
                            </div>
                        </div>
                        ...
                        <div class="col-xl-2 col-sm-4">
                            <div class="form-group mt-3 mt-sm-0">
                                ...
                                <input class="form-control" value="<?php echo e($stockIssue->DocDueDate); ?>" placeholder="Posting Date" readonly />
                            </div>
                        </div>
                    </div>
                    ...
                    <?php if($stockIssue->DocumentStatus == 'bost_Open'): ?>
                        <a href="<?php echo e(url('goodsreceipt/create/' . $stockIssue->DocEntry)); ?>" class="btn btn-info">Receive</a>
                    <?php endif; ?>
                </div> <!-- end card body-->
            </div> <!-- end card -->
        </div><!-- end col-->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.vertical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Laravel\laravel\resources\views/apps/stockReport/StockIssueDetail.blade.php ENDPATH**/ ?>