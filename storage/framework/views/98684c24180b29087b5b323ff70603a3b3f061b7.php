        ...
        <div class="board">
            <div class="tasks border">
                ...
                <div id="task-list-one" class="task-list-items">
                    <?php $__env->startComponent('apps.task.board-task-item', ['id' => 1, 'title' => 'Draft the new
                    ...
                    <?php $__env->startComponent('apps.task.board-task-item', ['id' => 2, 'title' => 'iOS App home
                    page', 'assignedTo' => 'James B','dueDate' => 'Today 4pm', 'noChecklists' =>
                    3, 'noComments' => 2,'priority' => 'Low', 'assigneeAvatar' =>
                    '/assets/images/users/avatar-7.jpg']); ?><?php echo $__env->renderComponent(); ?>

                    <?php $__env->startComponent('apps.task.board-task-item', ['id' => 3, 'title' => 'Write a release
            ...
            <div class="tasks border">
                ...
                <div id="task-list-two" class="task-list-items">
                    <?php $__env->startComponent('apps.task.board-task-item', ['id' => 4, 'title' => 'Invite user to
                    ...
                    <?php $__env->startComponent('apps.task.board-task-item', ['id' => 5, 'title' => 'Enable
            ...
            <div class="tasks border">
                ...
                <div id="task-list-three" class="task-list-items">
                    <?php $__env->startComponent('apps.task.board-task-item', ['id' => 6, 'title' => 'Code HTML
                    ...
                    <?php $__env->startComponent('apps.task.board-task-item', ['id' => 7, 'title' => 'Coordinate
            ...
            <div class="tasks border">
                ...
                <div id="task-list-four" class="task-list-items">
                    <?php $__env->startComponent('apps.task.board-task-item', ['id' => 8, 'title' => 'Kanban board
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.vertical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Laravel\laravel\resources\views/apps/task/board.blade.php ENDPATH**/ ?>