<div class="card <?php if(isset($bodyClass)): ?><?php echo e($bodyClass); ?><?php endif; ?>">
    <div class="card-body">
        <?php if(isset($status) && $status == 'Finished'): ?>
        <div class="badge badge-success float-right"><?php echo e($status); ?></div>
        <p class="text-success text-uppercase font-size-12 mb-2"><?php echo e($category); ?></p>
        <?php endif; ?>

        <?php if(isset($status) && $status == 'Ongoing'): ?>
        <div class="badge badge-warning float-right"><?php echo e($status); ?></div>
        <p class="text-warning text-uppercase font-size-12 mb-2"><?php echo e($category); ?></p>
        <?php endif; ?>

        <?php if(isset($status) && $status == 'Planned'): ?>
        <div class="badge badge-info float-right"><?php echo e($status); ?></div>
        <p class="text-info text-uppercase font-size-12 mb-2"><?php echo e($category); ?></p>
        <?php endif; ?>
    ...
    <div class="card-body border-top">
        <div class="row align-items-center">
                ...
                <ul class="list-inline mb-0">
                    ...
                    <li class="list-inline-item pr-2">
                        <a href="#" class="text-muted d-inline-block" data-toggle="tooltip" data-placement="top"
                            ...
                            <i class="uil uil-bars mr-1"></i> <?php echo e($DueDate); ?>
            ...
            <div class="col offset-sm-1">
                ...
                <a href="<?php echo e(url($url)); ?>" class="btn btn-small btn-success pull-right"> Detail </a>
            </div>
        </div>
    </div>
</div>
<!-- end card --><?php /**PATH D:\Projects\Laravel\laravel\resources\views/apps/project/project-item.blade.php ENDPATH**/ ?>