        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-footer">
                    <a href="<?php echo e(URL::previous()); ?>" class="btn btn-danger">Cancle</a> <a href="#" class="btn btn-primary float-right">Send Request</a>
                </div>
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.vertical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Laravel\laravel\resources\views/apps/reports/inventory/stockoverview.blade.php ENDPATH**/ ?>