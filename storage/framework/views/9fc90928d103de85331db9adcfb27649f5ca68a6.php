              ...
              <div class="clearfix">
                ...
                <div class="float-sm-left">
                    ...
                    <dl class="row mb-2 mt-3">
                      ...
                      <dd class="col-sm-9 font-weight-normal">#<?php echo e($goodsissued->DocNum); ?></dd>

                      <dt class="col-sm-3 font-weight-normal">Invoice Date :</dt>
                      <dd class="col-sm-9 font-weight-normal"><?php echo e($goodsissued->DocDate); ?></dd>

                      <dt class="col-sm-3 font-weight-normal">Due Date :</dt>
                      <dd class="col-sm-9 font-weight-normal"><?php echo e($goodsissued->DocDueDate); ?></dd>
                    </dl>
                </div>
              </div>
                  ...
                  <div class="col-12">
                      <div class="table-responsive">
                          <table class="table mt-4 table-centered table-hover">
                              ...
                              <tbody>
                                <?php $__currentLoopData = $goodsissued->DocumentLines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $docLine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td><?php if($docLine->LineStatus == 'bost_Close'): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.vertical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Laravel\laravel\resources\views/apps/inventory/inventorytransactions/goodsissue/goodsissued.blade.php ENDPATH**/ ?>