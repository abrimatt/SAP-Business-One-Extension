...
<?php $__env->startSection('breadcrumb'); ?>
  <div class="row page-title align-items-center">
    <div class="col-md-3 col-xl-6">
        <h4 class="mb-1 mt-0">Sales Invoice</h4>
    </div>
                  ...
                  <div class="card-body">
                      ...
                      <div class="clearfix">
                          ...
                          <div class="float-sm-left">
                              ...
                              <dl class="row mb-2 mt-3">
                                  ...
                                  <dd class="col-sm-9 font-weight-normal">#<?php echo e($invoice->DocNum); ?></dd>

                                  <dt class="col-sm-3 font-weight-normal">Invoice Date :</dt>
                                  <dd class="col-sm-9 font-weight-normal"><?php echo e($invoice->DocDate); ?></dd>

                                  <dt class="col-sm-3 font-weight-normal">Due Date :</dt>
                                  <dd class="col-sm-9 font-weight-normal"><?php echo e($invoice->DocDueDate); ?></dd>
                              </dl>
                          </div>
                      ...
                      <div class="row mt-4">
                          <div class="col-md-6">
                              ...
                              <h6 class="font-size-16"><?php echo e($invoice->CardCode); ?> - <?php echo e($invoice->CardName); ?></h6>
                              <address>
                          ...
                          <div class="col-md-6">
                              <div class="text-md-right">
                                  ...
                                  <h3> <?php echo e($invoice->DocCurrency); ?> <?php echo e($invoice->DocTotal); ?></h3>
                              </div>
                          </div> <!-- end col -->
                      </div>
                      <!-- end row -->
                          ...
                          <div class="col-12">
                              <div class="table-responsive">
                                  <table class="table mt-4 table-centered table-hover">
                                      ...
                                      <tbody>
                                        <?php $__currentLoopData = $invoice->DocumentLines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $docLine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                          ...
                          <div class="col-sm-6">
                              <div class="float-right mt-4">
                                  <p><span class="font-weight-medium">Sub-total:</span> <span
                                          class="float-right"><?php echo e($invoice->DocTotal); ?></span></p>
                                  
                                          <h3><?php echo e($invoice->DocTotal); ?> <?php echo e($invoice->DocCurrency); ?></h3>
                              </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.vertical', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\Laravel\laravel\resources\views/apps/salestransactions/invoice/invoice.blade.php ENDPATH**/ ?>