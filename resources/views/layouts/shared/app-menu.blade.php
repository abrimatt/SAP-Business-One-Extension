<ul class="metismenu" id="menu-bar">
    ...
    <li>
        ...
        <ul class="nav-second-level" aria-expanded="false">
            <li>
                <a href="{{ url('/items') }}">Stock Report</a>
            </li>
            <li>
                <a href="{{ url('/stockoverview') }}">Stock Overview</a>
            </li>
            <li>
                <a href="{{ url('/goodsIssue') }}">Stock Issued Report</a>
            </li>
            <li>
                <a href="{{ url('/goodsreceipt') }}">Stock Received Report</a>
            </li>
        </ul>
    </li>
