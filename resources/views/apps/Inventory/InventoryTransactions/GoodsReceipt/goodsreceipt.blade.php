              ...
              <div class="clearfix">
                ...
                <div class="float-sm-left">
                    ...
                    <dl class="row mb-2 mt-3">
                      ...
                      <dd class="col-sm-9 font-weight-normal">#{{ $stockReceipt->DocNum }}</dd>

                      <dt class="col-sm-3 font-weight-normal">Invoice Date :</dt>
                      <dd class="col-sm-9 font-weight-normal">{{ $stockReceipt->DocDate }}</dd>

                      <dt class="col-sm-3 font-weight-normal">Due Date :</dt>
                      <dd class="col-sm-9 font-weight-normal">{{ $stockReceipt->DocDueDate }}</dd>
                    </dl>
                </div>
              </div>
                  ...
                  <div class="col-12">
                      <div class="table-responsive">
                          <table class="table mt-4 table-centered table-hover">
                              ...
                              <tbody>
                                @foreach ($stockReceipt->DocumentLines as $docLine)
                                <tr>
                                    ...
                                    <td>
                                        @if ($docLine->LineStatus == 'bost_Close')
