          ...
          <div class="card-body">
              ...
              <div class="clearfix">
                ...
                <div class="float-sm-left">
                    ...
                    <dl class="row mb-2 mt-3">
                      ...
                      <dd class="col-sm-9 font-weight-normal">#{{ $grpo->DocNum }}</dd>

                      <dt class="col-sm-3 font-weight-normal">Invoice Date :</dt>
                      <dd class="col-sm-9 font-weight-normal">{{ $grpo->DocDate }}</dd>

                      <dt class="col-sm-3 font-weight-normal">Due Date :</dt>
                      <dd class="col-sm-9 font-weight-normal">{{ $grpo->DocDueDate }}</dd>
                    </dl>
                </div>
              </div>
              ...
              <div class="row mt-4">
                  <div class="col-md-6">
                      ...
                      <h6 class="font-size-16">{{ $grpo->CardCode }} - {{ $grpo->CardName }}</h6>
                      <address>
                          {{-- 795 Folsom Ave, Suite 600<br>
                          San Francisco, CA 94107<br>
                          <abbr title="Phone">P:</abbr> (123) 456-7890 --}}
                  ...
                  <div class="col-md-6">
                      <div class="text-md-right">
                          ...
                          <h3> {{ $grpo->DocCurrency }} {{ $grpo->DocTotal }}</h3>
                      </div>
                  </div> <!-- end col -->
              </div>
              <!-- end row -->
                  ...
                  <div class="col-12">
                      <div class="table-responsive">
                          <table class="table mt-4 table-centered table-hover">
                              ...
                              <tbody>
                                @foreach ($grpo->DocumentLines as $docLine)
                                <tr>
