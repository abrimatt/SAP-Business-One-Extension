                  ...
                  <div class="card-body">
                      ...
                      <div class="clearfix">
                          ...
                          <div class="float-sm-left">
                              ...
                              <dl class="row mb-2 mt-3">
                                  ...
                                  <dd class="col-sm-9 font-weight-normal">#{{ $invoice->DocNum }}</dd>

                                  <dt class="col-sm-3 font-weight-normal">Invoice Date :</dt>
                                  <dd class="col-sm-9 font-weight-normal">{{ $invoice->DocDate }}</dd>

                                  <dt class="col-sm-3 font-weight-normal">Due Date :</dt>
                                  <dd class="col-sm-9 font-weight-normal">{{ $invoice->DocDueDate }}</dd>
                              </dl>
                          </div>
                      ...
                      <div class="row mt-4">
                          <div class="col-md-6">
                              ...
                              <h6 class="font-size-16">{{ $invoice->CardCode }} - {{ $invoice->CardName }}</h6>
                              <address>
                                  {{-- 795 Folsom Ave, Suite 600<br>
                                  San Francisco, CA 94107<br>
                                  <abbr title="Phone">P:</abbr> (123) 456-7890 --}}
                          ...
                          <div class="col-md-6">
                              <div class="text-md-right">
                                  ...
                                  <h3> {{ $invoice->DocCurrency }} {{ $invoice->DocTotal }}</h3>
                              </div>
                          </div> <!-- end col -->
                      </div>
                      <!-- end row -->
                          ...
                          <div class="col-12">
                              <div class="table-responsive">
                                  <table class="table mt-4 table-centered table-hover">
                                      ...
                                      <tbody>
                                        @foreach ($invoice->DocumentLines as $docLine)
                                        <tr>
                          ...
                          <div class="col-sm-6">
                              <div class="float-right mt-4">
                                  ...
                                  {{-- <p><span class="font-weight-medium">Discount (10%):</span> <span
                                          class="float-right"> &nbsp;&nbsp;&nbsp; {{ $invoice->DocTotal }}</span></p> --}}
                                          <h3>{{ $invoice->DocTotal }} {{ $invoice->DocCurrency }}</h3>
                              </div>
