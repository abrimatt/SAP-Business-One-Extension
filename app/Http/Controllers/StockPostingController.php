...
class StockPostingController extends Controller
{
    ...
    {
        $response = $this->_client->get('InventoryPostings')->getBody()->getContents();
        $stockpostings = json_decode($response);

        return view('apps.inventory.physicalinventory.stockposting.stockpostings', ['stockpostings' => $stockpostings]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $response = $this->_client->post('InventoryPostings', 
            ['json' => $collect]
        );
    ...
    {
        $response = $this->_client->get('InventoryPostings')->getBody()->getContents();
        $stockposting = json_decode($response);

        return view('apps.inventory.physicalinventory.stockposting.stockposting', ['stockposting' => $stockposting]);
    }
