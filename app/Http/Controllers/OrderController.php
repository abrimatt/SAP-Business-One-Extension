...
class OrderController extends Controller
{
    ...
    {
        $response = $this->_client->get('Orders')->getBody()->getContents();
        $orders = json_decode($response);

        return view('apps.salestransactions.order.orders', ['orders' => $orders]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $response = $this->_client->post('Orders', 
            ['json' => $collect]
        );
    ...
    {
        $response = $this->_client->get('Orders('.$id.')')->getBody()->getContents();
        $orders = json_decode($response);

        return view('apps.salestransactions.order.order', ['orders' => $orders]);
    }
