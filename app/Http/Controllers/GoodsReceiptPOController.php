...
class GoodsReceiptPOController extends Controller
{
    ...
    {
        $response = $this->_client->get('PurchaseDeliveryNotes')->getBody()->getContents();
        $grpos = json_decode($response);

        return view('apps.procurementtransactions.goodsreceiptpo.goodsreceiptspo', ['grpos' => $grpos]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $response = $this->_client->post('PurchaseDeliveryNotes', 
            ['json' => $collect]
        );
    ...
    {
        $response = $this->_client->get('PurchaseDeliveryNotes('.$id.')')->getBody()->getContents();
        $grpo = json_decode($response);

        return view('apps.procurementtransactions.goodsreceiptpo.goodsreceiptpo', ['grpo' => $grpo]);
    }
