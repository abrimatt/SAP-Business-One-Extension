...
class StockCountController extends Controller
{
    ...
    {
        $response = $this->_client->get('InventoryCountings')->getBody()->getContents();
        $counts = json_decode($response);

        return view('apps.inventory.physicalinventory.stockcount.stockcounts', ['stockcounts' => $counts]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $response = $this->_client->post('InventoryCountings', 
            ['json' => $collect]
        );
    ...
    public function show($id)
    {
        ...
        return view('apps.inventory.physicalinventory.stockcount.create_stockcount', ['stockcount' => $count]);
    }
